    ...
    <div class="container mx-auto max-w-screen-xl sm:px-10 px-4">
        <div class="bg-gray-50 bg-opacity-50 shadow-inner rounded-lg sm:pb-4">
            <div class="flex justify-between text-gray-400 px-4 border-b-2 bg-white bg-opacity-50 mb-2 sm:mb-4">
                <div class="cursor-default font-bold my-auto text-sm lg:text-xl">買い物リスト</div>
                <div class="py-4">
                    <a href="{{ route('user.shopping_lists.create') }}" class="px-4 py-2 border-b-2 text-sm sm:text-lg border-gray-200 font-bold hover:border-gray-500">
                        食べ物の追加
                    </a>
                </div>
            </div>
            <div class="mx-4">
                <table class="w-full sm:text-lg text-sm mb-2 sm:mb-4 text-gray-500">
