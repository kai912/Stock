    ...
    <div class="container mx-auto max-w-screen-xl sm:px-10">
        <div class="justify-center grid sm:grid-cols-3">
            <div class="sm:col-start-2 shadow-lg rounded-lg">
                <div class="pl-4 bg-gray-50 bg-opacity-50 py-2 w-full border-b-2 border-gray-200 text-gray-400 font-bold lg:text-xl">場所を追加</div>
                <div class="py-4">
                @if($errors->any())
                ...
                @endif
                    <form action="{{ route('user.stocks.create') }}" method="post">
                        @csrf
